...
var endpointBindings = map[string]endpointBinding{
	...
	"document.sort-children":              {Method: "PUT", Path: "/document/{id}/sort-children", Response: &ObjectSchema{Type: "object", Description: "PUT /document/root/sort-children when [parent-id] is omitted (Umbraco 18.1+)"}},
	...
	"media.sort-children":          {Method: "PUT", Path: "/media/{id}/sort-children", Response: &ObjectSchema{Type: "object", Description: "PUT /media/root/sort-children when [parent-id] is omitted (Umbraco 18.1+)"}},
